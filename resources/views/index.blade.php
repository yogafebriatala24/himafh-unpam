...
<html lang="en">
    <head>
        ...
        />
        <link
            href="{{asset('frontend/home/assets/vendor/bootstrap-icons/bootstrap-icons.css')}}"
            rel="stylesheet"
        />
        <link
            href="{{asset('frontend/home/assets/vendor/boxicons/css/boxicons.min.css')}}"
            rel="stylesheet"
        />
        <link
            href="{{asset('frontend/home/assets/vendor/glightbox/css/glightbox.min.css')}}"
            rel="stylesheet"
        />
        <link href="{{asset('frontend/home/assets/vendor/remixicon/remixicon.css')}}" rel="stylesheet" />
        <link
            href="{{asset('frontend/home/assets/vendor/swiper/swiper-bundle.min.css')}}"
            rel="stylesheet"
        />
        ...
        <header id="header" class="fixed-top d-flex align-items-center">
            ...
            >
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        <li>
                            <a class="nav-link scrollto active" href="{{route('depan')}}"
                                >Home</a
                            >
                        </li>
                        <li>
                        ...
                        <div class="col-6 col-lg-2 d-flex align-items-stretch">
                            ...
                            >
                                <div class="member-img">
                                    <img
                                        src="{{asset('frontend/home/assets/img/team/team-1.jpg')}}"
                                        class="img-fluid"
                                        alt=""
                                    />

                                    <a href="{{route('profile')}}" class="btn mt-1 py-2"
                                        >Profil Kandidat</a
                                    >
                                </div>
                        ...
                        <div class="col-6 col-lg-2 d-flex align-items-stretch">
                            ...
                            >
                                <div class="member-img">
                                    ...
                                    <a href="profile.html" class="btn mt-1 py-2"
                                        >Profil Kandidat</a
                                    >
                                </div>
                                <div class="member-info">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-wrap">
                                    <div class="testimonial-item">
                                        <img
                                            src="{{asset('frontend/home/assets/img/testimonials/testimonials-1.jpg')}}"
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-wrap">
                                    <div class="testimonial-item">
                                        <img
                                            src="{{asset('frontend/home/assets/img/testimonials/testimonials-2.jpg')}}"
                                            class="testimonial-img"
                                            alt=""
                                        />
                                        <h3>Sara Wilsson</h3>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-wrap">
                                    <div class="testimonial-item">
                                        <img
                                            src="{{asset('frontend/home/assets/img/testimonials/testimonials-3.jpg')}}"
                                            class="testimonial-img"
                                            alt=""
                                        />
                                        <h3>Jena Karlis</h3>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-wrap">
                                    <div class="testimonial-item">
                                        <img
                                            src="{{asset('frontend/home/assets/img/testimonials/testimonials-4.jpg')}}"
                                            class="testimonial-img"
                                            alt=""
                                        />
                                        <h3>Matt Brandon</h3>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-wrap">
                                    <div class="testimonial-item">
                                        <img
                                            src="{{asset('frontend/home/assets/img/testimonials/testimonials-5.jpg')}}"
                                            class="testimonial-img"
                                            alt=""
                                        />
                                        <h3>John Larson</h3>
                        ...
                        >
                            <div class="contact-about">
                                ...
                                <div class="social-links">
                                    <a
                                        href="https://twitter.com/HimaFhu"
                                        class="twitter"
                                    ...
                                    ></a>
                                    <a
                                        href="https://instagram.com/himafh_unpam"
                                        class="instagram"
